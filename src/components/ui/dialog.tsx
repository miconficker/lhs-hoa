...
>(({ className, children, ...props }, ref) => {
  ...
  const contentProps = containsDescription
    ? ariaDescribedBy !== undefined
      ? { ...rest, "aria-describedby": ariaDescribedBy }
      : rest
    : { ...rest, "aria-describedby": ariaDescribedBy ?? undefined };
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        // Radix warns if there is no description and aria-describedby isn't
        // explicitly opted out. Only opt out when no DialogDescription exists.
        {...contentProps}
      >
        {children}
